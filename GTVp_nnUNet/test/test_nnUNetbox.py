...
from testdataset_GTxy_nnUNetbox import SAM3DTestDataset
...
if __name__ == '__main__':
    ...
    box_mask_dir = "/home/wusi/SAM-Med3Ddata/dataset/test/nnUNet_box"    # 重采样后的Box
    ori_img_dir = "/home/wusi/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset001_GTVp/imagesTs"      # 最最原始 CT 路径
    save_dir = '/home/wusi/SAM-Med3Ddata/TestResult/GTxy_nnUNet_box'          # 保存预测结果

    dataset = SAM3DTestDataset(img_dir=img_dir, mask_dir=mask_dir, box_mask_dir=box_mask_dir, img_size=256)
    dataloader = DataLoader(dataset, batch_size=1, shuffle=False)

    sam_checkpoint = "/home/wusi/SAM-Med3Ddata/TrainResult/GTxy_nnUNet_box/fold_5/weights/best.pth"
    model_type = "vit_b"
