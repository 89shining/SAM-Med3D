...
#   ① 还原为原始尺寸：128³ → 原图尺寸
# ============================================================
def restore_to_original_size(pred_128, original_shape, sitk_img, save_path):

    Z0, H0, W0 = original_shape
    z1, h1, w1 = pred_128.shape

    zoom_factor = np.array([Z0, H0, W0]) / np.array([z1, h1, w1])

    restored = zoom(pred_128, zoom_factor, order=0).astype(np.uint8)

    pred_itk = sitk.GetImageFromArray(restored)
    pred_itk.CopyInformation(sitk_img)
...
if __name__ == "__main__":
    ...
    save_dir = "/home/wusi/SAM-Med3Ddata/Eso_CTV/TestResult"
    ...
    sam_checkpoint = "/home/wusi/SAM-Med3Ddata/Eso_CTV/TrainResult/fold_3/weights/best.pth"
